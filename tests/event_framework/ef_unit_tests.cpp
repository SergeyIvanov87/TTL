...
using EventFramework = EventFrameworkFactory<TestEvent, TestSecondEvent>;
TEST_F(EFEventSubscriberFixture, receiveSimpleEvent) {
    ...
    auto secondEvent = EventFramework::createControllerEvent<TestSecondEvent>(
                                TestSecondEventID::TEID_1,
                                TestSecondEventModifier::TEIM_NONE,
